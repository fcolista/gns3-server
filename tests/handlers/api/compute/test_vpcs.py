...
def test_vpcs_nio_update_udp(http_compute, vm):
    response = http_compute.put("/projects/{project_id}/vpcs/nodes/{node_id}/adapters/0/ports/0/nio".format(project_id=vm["project_id"], node_id=vm["node_id"]), {"type": "nio_udp",
                                                                                                                                                                  "lport": 4242,
                                                                                                                                                                  "rport": 4343,
                                                                                                                                                                  "rhost": "127.0.0.1",
                                                                                                                                                                  "filters": []},
